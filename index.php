...
<head>
  ...
  <script>
    function copyCode(_this) {
      const element = document.querySelector('#copy_embed_code');
      const btn = _this;
      const svg_use = _this.querySelector('svg use');
      // element.select();
      // element.setSelectionRange(0, 99999);
      // document.execCommand('copy');
      var textToCopy = document.getElementById('copy_embed_code');
      ...
      document.execCommand('copy');
      window.getSelection().removeAllRanges();
      svg_use.setAttribute("xlink:href", "#check2");
      btn.setAttribute("aria-label", "Copied");
      setTimeout(function() {
        svg_use.setAttribute("xlink:href", "#clipboard");
...
<body>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div class="btn-group">
            ...
            <button class="btn btn-outline-primary" data-bs-target="#exampleModalToggle4" data-bs-toggle="modal" data-bs-dismiss="modal">
              Manual Installation
            </button>
            <button class="btn btn-outline-primary" data-bs-target="#exampleModalToggle3" data-bs-toggle="modal" data-bs-dismiss="modal">
              Get Code
            </button>
          </div>
        </div>
  ...
  <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div class="btn-group">
            <button class="btn btn-outline-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal" data-bs-dismiss="modal">
              How to get Shop URL
            </button>
            <button class="btn btn-outline-primary" data-bs-target="#exampleModalToggle4" data-bs-toggle="modal" data-bs-dismiss="modal">
              Manual Installation
  ...
  <div class="modal fade" id="exampleModalToggle3" aria-hidden="true" aria-labelledby="exampleModalToggleLabel3" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalToggleLabel3">Embed Code</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="cody_code_box bg-secondary text-bg-secondary">
            <pre><code  id="copy_embed_code"  class="code">&lt;script&gt;
...
&lt;/script&gt;</code></pre>
            <button type="button" class="btn-clipboard text-bg-light" aria-label="Copy" onclick="copyCode(this);">
  ...
  <div class="modal fade" id="exampleModalToggle4" aria-hidden="true" aria-labelledby="exampleModalToggleLabel4" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalToggleLabel4">Manual Installation</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <video width="100%" controls muted>
